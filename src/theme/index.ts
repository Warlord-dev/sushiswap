...
export const lightTheme = {
  backgroundColor: "radial-gradient(circle at center top, rgb(247, 243, 244), rgb(243, 237, 239)) 0% 0% / cover fixed",
  bodycolor: 'rgb(20, 1, 8)',
  linkcolor: 'rgb(141, 124, 130)',
  cardbackgroundColor: 'radial-gradient(circle at center top, #f3f4f7, #f3edef)',
